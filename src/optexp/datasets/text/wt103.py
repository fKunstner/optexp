...
def wt103_loader(
    ...
    vocab = cached_load_vocab(
        tokenizer, train_iter, vocab_path=save_path / "WikiText103" / "wiki.vocab.pkl"
    )
    ...
    train_data = cached_tokenize(device, tokenizer, train_iter, train_path, vocab)
    val_data = cached_tokenize(device, tokenizer, val_iter, val_path, vocab)
...
def cached_load_vocab(tokenizer, train_iter, vocab_path):
...
def cached_tokenize(device, tokenizer, train_iter, train_path, vocab):
